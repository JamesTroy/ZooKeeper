...
protected:
  ...
  UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Zoo|Camera",
   ...
   */
  UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Zoo|Tools",
            meta = (AllowPrivateAccess = "true"))
  TObjectPtr<UToolComponent> ToolComp;

  // Allow the player controller to assign input actions programmatically.
  friend class AZooPlayerController;

  // ---------------------------------------------------------------
  //  Enhanced Input Actions (assigned in Blueprint or by controller)
  // ---------------------------------------------------------------
  ...
  UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Zoo|Movement",
            meta = (ClampMin = "0.0"))
  float WalkSpeed;
...
private:
  ...
  /** Updates the character movement component's max walk speed based on sprint
   * state. */
  ...
  UPROPERTY(VisibleInstanceOnly, BlueprintReadOnly, Category = "Zoo|Movement",
            meta = (AllowPrivateAccess = "true"))
  bool bIsSprinting;
};
